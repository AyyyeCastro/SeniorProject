            ...
            <?php foreach ($messageLog as $row): ?>
               <?php if ($row['isMessageReplied'] == 'No' && $row['isMessageHidden'] != 'YES'): ?>
                  <tr class="unreplied <?php if (strpos($row['messageTitle'], 'RE | SALE CONFIRMED:') !== false)
                     ...
                     <td>
                        <a
                           href="viewMessage.php?messageID=<?php echo $row['messageID']; ?>&parentID=<?php echo $row['parentID']; ?>&receiverID=<?= $row['senderID']; ?>&receiverInnie=<?= $row['senderInnie']; ?>">
               ...
               <?php if ($row['isMessageReplied'] != 'No' && $row['isMessageHidden'] != 'YES'): ?>
                  <tr
                     ...
                     <td class="">
                        <a href="viewMessage.php?messageID=<?php echo $row['messageID']; ?>&parentID=<?php echo $row['parentID']; ?>&receiverID=<?= $row['senderID']; ?>&receiverInnie=<?= $row['senderInnie']; ?>"
                           class="customLink">
                           <?php echo $row['messageTitle']; ?>
                        </a>
                     </td>
