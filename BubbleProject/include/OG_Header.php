        ...
        <?php if (isUserLoggedIn()): ?>
          <li class="nav-item"><samp></samp>
            <a class="nav-link make-centered" href="postListing.php">
              <button class="btn"><i class="fa-solid fa-cash-register fa-xl"></i></button> Create Task
            </a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="viewSaleHistory.php">
                <button class="btn"><i class="fa-solid fa-boxes-packing fa-lg"></i></button>Outgoing Tasks
              </a>
              <a class="dropdown-item" href="viewPurchaseHistory.php">
                <button class="btn"><i class="fa-solid fa-box-archive fa-lg"></i></button>Completed Tasks
              </a>
